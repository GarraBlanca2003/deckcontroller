...
if [ "$FIRST_RUN" = true ]; then
    if [ -f "$LAUNCHER_SH" ]; then
        ...
        cp "$CLONE_DIR/image/hero.png" "$GRID_DIR/${APP_DESKTOP_NAME}_hero.png"
        cp "$CLONE_DIR/image/logo.png" "$GRID_DIR/${APP_DESKTOP_NAME}_logo.png"
        cp "$CLONE_DIR/image/library_hero.png" "$GRID_DIR/${APP_DESKTOP_NAME}_library_hero.png"
        cp "$CLONE_DIR/image/library_cover.png" "$GRID_DIR/${APP_DESKTOP_NAME}_library_cover.png"
        cp "$CLONE_DIR/image/icon.png" "$GRID_DIR/${APP_DESKTOP_NAME}_icon.png"
        cp "$CLONE_DIR/image/grid.png" "$GRID_DIR/${APP_DESKTOP_NAME}_grid.png"
    done
    echo "✅ Art installed"
